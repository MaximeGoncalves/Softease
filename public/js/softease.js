	 ...
	 var pieChart = new Chart(pie, {
		...
		data: {
		 ...
		 datasets: [
			{
			 data: tab,
			 backgroundColor: ['rgba(231,76,60,0.8)','rgba(231,76,60,0.8)','rgba(231,76,60,0.8)','rgba(231,76,60,0.8)','rgba(231,76,60,0.8)'],
			 // backgroundColor: ['rgba(231,76,60,0.8)','rgba(231,76,40,0.8)','rgba(231,76,20,0.8)','rgba(231,76,40,0.8)'],
			}
		 ]
		},
		options: {
...
//Technician
 ...
 $('#search').keyup(function () {
	...
	var query = $(this).val();
	var state = $('#sort').val()
	var user = $('#technician').val()

	if (query.length > minlenght) {
	 $.ajax({
		url: '/admin/ticket',
		method: 'GET',
		data: {
